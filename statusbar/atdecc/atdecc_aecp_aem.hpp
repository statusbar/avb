...
static_assert(offsetof(AemDu, status_cdl_h) == 2, "status_cdl_h must be at offset 2");
static_assert(offsetof(AemDu, control_data_length_l) == 3, "control_data_length_l must be at offset 3");
